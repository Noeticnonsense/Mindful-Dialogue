...
export const analyzeConversationBodyPartyNamesMin = 2;
export const analyzeConversationBodyPartyNamesMax = 2;
...
export const AnalyzeConversationBody = zod.object({
  ...
  "partyNames": zod.array(zod.string().min(1)).min(analyzeConversationBodyPartyNamesMin).max(analyzeConversationBodyPartyNamesMax).optional().describe('Names for the two conversation participants, used when assigning unlabeled or generic speaker lines')
})
...
export const AnalyzeConversationResponse = zod.object({
  ...
  "parsedConversation": zod.array(zod.object({
  "id": zod.string(),
  "speaker": zod.string(),
  ...
  "emotionalProgression": zod.array(zod.object({
  "speaker": zod.string(),
  "turn": zod.number(),
  "state": zod.string(),
  "confidence": zod.number(),
  ...
  "reflectionMessages": zod.array(zod.object({
